...
return [
    ...
    'attributes' => [
        ...
        'deadline' => 'Határidő',
        'deadline_help' => 'Határidő beállítást akkor ajánlunk, ha több hónap múlva esedékes a költés, pl gépjármű adó vagy karácsonyi ajándék. Ha egy hónapon belül van már az időpont, több helyen is figyelmeztetünk, hogy erre valószínűleg ideje lenne félretenni a havi fizetésből.',
        'email' => 'E-mail',
        'goal' => 'Cél',
        'goal_help' => 'A célokról itt olvashatsz bővebben:',
        'icon' => 'Ikon',
        'icon_help' => 'Ha egybe szeretnéd látni az összeset, kulcsszavakk együtt, akkor:',
        'is_dynamic' => 'Dinamikus cél',
        'is_dynamic_help' => 'Ha egy cél dinamikus, akkor minden alkalommal amikor fizetsz a perselyből, ugyanannyival csökken a cél is. Ezt például hiteleknél tudod használni.',
        'is_important' => 'Fontos',
        'is_important_help' => 'Ha valamit fontosnak jelölsz, az az automatikus beosztáskor előrébb kerül a sorban. Azokat a perselyeket érdemes fontosnak jelölni, amiből rendszeresen költesz, és minden hónapban újra kell tölteni, pl számlák, vásárlás.',
        'locale' => 'Nyelv',
        'name' => 'Név',
