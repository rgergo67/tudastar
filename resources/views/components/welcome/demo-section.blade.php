<section class="bg-indigo-600">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div class="lg:text-center">
            <h2 id="proba" class="mt-2 mb-10 text-3xl leading-8 font-extrabold text-white sm:text-4xl">
                Próbáld ki regisztráció nélkül!
            </h2>
            <div class="w-full sm:max-w-2xl text-justify mt-4 max-w-2xl text-xl text-white lg:mx-auto prose">
                <p>Egy teljesen üres teszt fiókban tudod kipróbálni a beosztom.hu működését. Az adatokat 2 napig titkosítva tároljuk, majd töröljük.</p>
