                ...
                <main class="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
                    <div class="sm:text-center lg:text-left">
                        <h1 class="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-900 sm:text-7xl">
                            ...
                            <span class="block text-emerald-600 xl:inline">mint a szüleidnek!</span>
                        </h1>
                        ...
                        <div class="text-center w-100 mt-6">
                            <a href="{{ route('knowledge.show', 'tanuld-meg-beosztani-a-penzed-fiatalon') }}" class="text-emerald-600">Vagy olvass róla bővebben</a>
                        </div>
                    </div>
                </main>
            </div>
